{
	const items = Array.from(document.querySelectorAll('.navigate > .navlink'));
	class Item {
		constructor(el){
			this.DOM = {};
			this.DOM.el = el;
			this.DOM.name = el.querySelector('.navlink-name');
			this.colors = {
				active: window.getComputedStyle(this.DOM.el).getPropertyValue('color')
			};
